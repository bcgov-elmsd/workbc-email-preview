const staticURL = "https://mobile.es.workbc.ca/images/logos/";
export function createHTMLEmail(title: string, mainContent: string[], boxContent: string[], endContent: string[]) {
  let html = /*html*/ `
